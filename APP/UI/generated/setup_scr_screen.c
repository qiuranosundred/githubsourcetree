...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_btn_1, 4, 5);
    lv_obj_set_size(ui->screen_btn_1, 45, 33);
    ...
    lv_obj_set_pos(ui->screen_btn_2, 77, 5);
    lv_obj_set_size(ui->screen_btn_2, 45, 33);
    ...
    lv_obj_set_pos(ui->screen_sw_1, 43, 49);
    ...
    lv_obj_set_pos(ui->screen_bar_1, 19, 89);
    lv_obj_set_size(ui->screen_bar_1, 92, 20);
