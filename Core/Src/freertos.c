...
void framSaveTaskFun(void const * argument);
void communicationTaskFun(void const * argument);
...
/* USER CODE BEGIN Header_framSaveTaskFun */
/**
* @brief Function implementing the FramSaveTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_framSaveTaskFun */
void framSaveTaskFun(void const * argument)
{
  /* USER CODE BEGIN framSaveTaskFun */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END framSaveTaskFun */
}

/* USER CODE BEGIN Header_communicationTaskFun */
/**
* @brief Function implementing the CommunicationTa thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_communicationTaskFun */
void communicationTaskFun(void const * argument)
{
  /* USER CODE BEGIN communicationTaskFun */
  /* Infinite loop */
  for(;;)
  {
